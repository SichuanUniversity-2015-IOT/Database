										...
										<form action="" class="form-horizontal" name="search_form" id="search_form" role="form">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="row">
													<div class="col-md-2">
														<input type="text" class="form-control" placeholder="输入教师名称" name="tName">
													...
													<button type="button" class="btn default" id="change_button">切换到学生用户</button>
...
<script>
function test(){
  	window.location = "teacherPrint.jsp";
  }
</script>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
  <% int teacherCount = Integer.parseInt((String)session.getAttribute("teacherCount"));
  	 int userCount = Integer.parseInt((String)session.getAttribute("userCount"));
  	 int studentCount = Integer.parseInt((String)session.getAttribute("studentCount")); %>
<!DOCTYPE html>
<!-- 
    ...
    <script type="text/javascript">
        ...
        var option = {
            ...
            series: [{
                name: '个数',
                type: 'bar',
                data: [userCount, teacherCount, studentCount]
            }]
        };

...
function initPage(){
	var tName = "<%=tName%>";
	$.post("../../userSearch",{tName: tName},function(data){
		var html="";
		var userData=eval("("+data+")");
		
			//alert("isTeacher");
			var list=eval(userData.teacherList);
		...
		html=html+"														<button type=\"button\" class=\"btn btn-circle red\" onclick=\"window.location='teacherDelete.jsp?tID="+tID+"'\">删除</button>";

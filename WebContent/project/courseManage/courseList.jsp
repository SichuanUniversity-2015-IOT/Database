...
<!-- BEGIN HEAD -->
	...
	<body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed page-sidebar-closed-hide-logo page-container-bg-solid">
										...
										<form action="" class="form-horizontal" name="search_form" id="search_form" role="form">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="row">
													<div class="col-md-3">
														<input type="text" class="form-control" placeholder="输入课程名称" name="cName">
													...
													<button type="button" class="btn green" id="submit_button">搜索</button>
														...
														<button type="button" class="btn default" id="add_button">添加课程</button>
													</div>
												</div>
											</div>
										</form>
		...
		<script src="js/courseList.js" type="text/javascript"></script>
</script>
<!-- END JAVASCRIPTS -->
<script>
...
<script>
function test(){
  	window.location = "coursePrint.jsp";
  }
</script>
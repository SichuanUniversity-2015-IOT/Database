...
function initPage(){
	var cName = "<%=cName%>";
	$.post("../../courseSearch",{cName: cName},function(data){
		var html="";
		...
		html=html+"														<button type=\"button\" class=\"btn btn-circle red\" onclick=\"window.location='courseDelete.jsp?cID="+cID+"'\">删除</button>";
		html=html+"														<button type=\"button\" class=\"btn btn-circle default\" onclick=\"window.location='courseList.jsp'\">返回</button>";
		html=html+"													</div>";
		html=html+"												</div>";
		html=html+"											</div>";
